...
<body>
	...
	<div class="page-head">
		<h2 class="pull-left" style="color: #428bca;">Absence Deduction List</h2>
					...
					<div class="col-md-12">
						...
						<div class="widget">
							...
							<div class="widget-head">
								<div class="pull-left">Absence Deduction List</div>
							...
							<div class="widget-content">
								...
								<div class="table-responsive">
									...
									<c:if test="${!empty absenceDeductionList}">
										<table class="table table-striped" id="table1">
											...
											<tbody>
												<c:forEach items="${absenceDeductionList}" var="absenceDeduction"
													varStatus="tr">
													<tr class="row_no_${tr.count}">
													
														<td class="text-center">${tr.count}</td>
														<td class="text-center">${absenceDeduction.employee.fullname}</td>
														<td class="text-center">${absenceDeduction.employee.employeeId}</td>
														<td class="text-center">${absenceDeduction.employee.designation.name}</td>
														<td class="text-center">${absenceDeduction.employee.department.name}</td>
														<td class="text-center">${absenceDeduction.paymentMonth.payName}</td>	
														<td class="text-center">${absenceDeduction.deductAmount}</td>	
														<td class="text-center">${absenceDeduction.deductDays}</td>	
														<td class="text-center">${absenceDeduction.remarks}</td>																									
														<td class="text-center">${absenceDeduction.createdBy}</td>
														<td class="text-center"><fmt:formatDate pattern = "dd-MM-yyyy HH:MM:ss a" value = "${absenceDeduction.createdDate}" /></td>
															<td class="text-center">
															<a
															href="${pageContext.request.contextPath}/editAbsenceDeduction.htm?id=${absenceDeduction.id}"><i
