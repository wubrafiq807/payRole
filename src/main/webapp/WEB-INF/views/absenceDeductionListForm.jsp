...
<body>
	...
	<div class="page-head">
		<h2 class="pull-left" style="color: #5BBC2E;">Absence Deduction</h2>	
				...
				<div class="widget wgreen">
					...
					<div class="widget-content">
						<div class="padd">
							...
							<!-- Form starts.  -->
							<form:form id="absenceDeductionForm" cssClass="form-horizontal" method="GET" modelAttribute="absenceDeductionForm"
								action="${pageContext.request.contextPath}/absenceDeductionList.htm"
