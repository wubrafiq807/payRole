...
<c:url var="findURL" value="/checkWorkLocation.htm" />
	...
	$(document).ready(function() {
		...
		$('.req-save-update-btn').click(function() {
			...
			if ($('#name').val().trim().length > 0) {
				...
				w2alert("Please Input Work Location Name.");
				return flag;
			}
			...
			if (!flag) {
				deptCheckResp = checkHoliday();
			}

			if (deptCheckResp) {
				$(".req-save-update-btn").prop('disabled', true);
				$('#workLocationForm').submit();
			} else {
				$(".req-save-update-btn").prop('disabled', false);
				$('#name').value = "";
				$('#name').focus();
				w2alert("Work Location already exist!!");
				return flag;
			}
		});
...
<body>
	...
	<div class="page-head">
		<c:choose>
			<c:when test="${edit}">
				<h2 class="pull-left" style="color: #5BBC2E;">Edit Work Location</h2>
			</c:when>
			<c:otherwise>
				<h2 class="pull-left" style="color: #5BBC2E;">Add New Work Location</h2>
			</c:otherwise>
		</c:choose>
			...
			<div class="col-md-12">
				<div class="widget wgreen">
					...
					<div class="widget-content">
						<div class="padd">
							...
							<!-- Form starts.  -->
							<form:form id="workLocationForm" cssClass="form-horizontal"
								method="POST" modelAttribute="workLocationForm"
								action="${pageContext.request.contextPath}/saveWorkLocation.htm"
								class="form-horizontal" role="form">

								<form:input type="hidden" path="id" value="${workLocation.id}"
								...
								<div class="form-group">
									...
									<div class="col-lg-5">
										...
										<form:input id="name" path="name" value="${workLocation.name}"
											class="form-control" />
									</div>
								</div>
										...
										<c:when test="${edit}">
											...
											<div class="col-lg-1 col-xs-4">
												<a class="btn btn-sm btn-danger"
													href="${pageContext.request.contextPath}/newWorkLocationForm.htm">Cancel</a>
											</div>
										</c:when>
										<c:otherwise>
											<div class="col-lg-offset-2 col-lg-1 col-xs-4" id="">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="widget">
							<div class="widget-head">
								<div class="pull-left">Work Location Details</div>
								<div class="widget-icons pull-right">
									<a href="#" class="wminimize"><i class="fa fa-chevron-up"></i></a>
									<a href="#" class="wclose"><i class="fa fa-times"></i></a>
								</div>
							...
							<div class="widget-content">
								<div class="table-responsive">
									<c:if test="${!empty workLocationList}">
												...
												<c:forEach items="${workLocationList}" var="workLocation"
													...
													<tr>
														...
														<td class="text-center"><c:out
																value="${workLocation.name}" /></td>
														
														<td class="text-center"><a
															class="btn btn-primary custom"
															href="editWorkLocation.htm?id=${workLocation.id}">Edit</a> <a
															class="btn btn-danger custom"
															href="deleteWorkLocation.htm?id=${workLocation.id}"
