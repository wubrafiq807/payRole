...
<body>
	...
	<div class="page-head">
		<h2 class="pull-left" style="color: #5BBC2E;">Additional Salary List</h2>	
				...
				<div class="widget wgreen">
					...
					<div class="widget-content">
						<div class="padd">
							...
							<!-- Form starts.  -->
							<form:form id="additionalSalaryForm" cssClass="form-horizontal" method="GET" modelAttribute="additionalSalaryForm"
								action="${pageContext.request.contextPath}/additionalSalaryList.htm"
