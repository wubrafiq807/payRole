...
<body>
	...
	<div class="page-head">
		<h2 class="pull-left" style="color: #5BBC2E;">Generate Allowance</h2>	
				...
				<div class="widget wgreen">
					...
					<div class="widget-content">
						<div class="padd">
							...
							<!-- Form starts.  -->
							<form:form id="allowanceForm" cssClass="form-horizontal" method="POST" modelAttribute="allowanceForm"
								action="${pageContext.request.contextPath}/generateAddAllowanceForm.htm"
