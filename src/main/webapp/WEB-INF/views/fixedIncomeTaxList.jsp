...
<body>
	...
	<div class="page-head">
		<h2 class="pull-left" style="color: #428bca;">Monthly Fixed Income Tax List</h2>
					...
					<div class="col-md-12">
						...
						<div class="widget">
							...
							<div class="widget-head">
								<div class="pull-left">Monthly Fixed Income Tax List</div>
							...
							<div class="widget-content">
								...
								<div class="table-responsive">
									...
									<c:if test="${!empty fixedIncomeTaxList}">
										<table class="table table-striped" id="table1">
											...
											<tbody>
												<c:forEach items="${fixedIncomeTaxList}" var="fixedIncomeTax"
													varStatus="tr">
													<tr class="row_no_${tr.count}">
													
														<td class="text-center">${tr.count}</td>
														<td class="text-center">${fixedIncomeTax.employee.fullname}</td>
														<td class="text-center">${fixedIncomeTax.employee.employeeId}</td>
														<td class="text-center">${fixedIncomeTax.employee.designation.name}</td>
														<td class="text-center">${fixedIncomeTax.employee.department.name}</td>
														<td class="text-center">${fixedIncomeTax.taxAmount}</td>		
														<td class="text-center">${fixedIncomeTax.remarks}</td>																									
														<td class="text-center">${fixedIncomeTax.createdBy}</td>
														<td class="text-center"><fmt:formatDate pattern = "dd-MM-yyyy HH:MM:ss a" value = "${fixedIncomeTax.createdDate}" /></td>
															<td class="text-center">
															<a
															href="${pageContext.request.contextPath}/editFixedIncomeTax.htm?id=${fixedIncomeTax.id}"><i
