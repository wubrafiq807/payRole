...
<body>
	...
	<div class="page-head">
		<h2 class="pull-left" style="color: #5BBC2E;">Advance Deduction List Form</h2>	
				...
				<div class="widget wgreen">
					...
					<div class="widget-content">
						<div class="padd">
							...
							<!-- Form starts.  -->
							<form:form id="advanceForm" cssClass="form-horizontal" method="GET" modelAttribute="advanceForm"
								action="${pageContext.request.contextPath}/advanceList.htm"
