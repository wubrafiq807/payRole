...
<c:url var="saveSalaryOnPage" value="/saveSalaryOnPage.htm" />
...
<script>
	var saveSalaryOnPageUrl = '<c:out value="${saveSalaryOnPage}"/>';
	...
	$(document).ready(function() {
		...
		$('.req-save-update-btn').click(function() {
			...
			if ($('#grossSalary').val().trim().length > 0) {
				...
				flag = true;
				w2alert("Please Input Gross Salary.");
				return false;
			}
			
			if ($('#basicSalary').val().trim().length > 0) {
				flag = false;
			} else {
				flag = true;
				w2alert("Please Input Basic Salary.");
				return false;
			}
			
			if ($('#otherSalary').val().trim().length > 0) {
				flag = false;
			} else {
				flag = true;
				w2alert("Please Input Others Salary.");
				return false;
			}
			
			if ($('#medical').val().trim().length > 0) {
				flag = false;
			} else {
				flag = true;
				w2alert("Please Input Medical Salary.");
				return false;
			}
			if ($('#houseRent').val().trim().length > 0) {
				flag = false;
			} else {
				flag = true;
				w2alert("Please Input House Rent.");
				return false;
			}
			if ($('#conveyance').val().trim().length > 0) {
				flag = false;
			} else {
				flag = true;
				w2alert("Please Input Conveyance.");
				return false;
			}
			
			if ($('#consalitedSalary').val().trim().length > 0) {
				flag = false;
			} else {
				flag = true;
				w2alert("Please Input Consolidated Salary.");
				return false;
			}			
		...
		$('.req-save-update-btn-ajax').click(function() {
			...
			if (!flag) {
				var beanData = {
					...
					consalitedSalary : $('#consalitedSalary').val(),
					remarks : $('#remarks').val()
...
<body>
	...
	<div class="page-head">
		<h2 class="pull-left" style="color: #5BBC2E;">Assign Salary to Employee Form</h2>
				...
				<div class="widget wgreen">
					...
					<div class="widget-content">
						<div class="padd">
							...
							<!-- Form starts.  -->
							<form:form id="salaryForm" cssClass="form-horizontal"
								method="POST" modelAttribute="salaryForm"
								action="${pageContext.request.contextPath}/saveSalary.htm"
								...
								<div class="form-group">
									...
									<div class="col-lg-5">
										<input type="number" class="form-control" name="grossSalary"
											value="${salary.grossSalary}" id="grossSalary">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-lg-5">
										<input type="number" class="form-control" name="basicSalary"
											value="${salary.basicSalary}" id="basicSalary">
									</div>
								</div>
								
								<div class="form-group">
									<label class="col-lg-2 control-label">Others Salary:</label>
									<div class="col-lg-5">
										<input type="number" class="form-control" name="otherSalary"
											value="${salary.otherSalary}" id="otherSalary">
									</div>
								</div>
								<div class="form-group">
									<label class="col-lg-2 control-label">Medical:</label>
									<div class="col-lg-5">
										<input type="number" class="form-control" name="medical"
											value="${salary.medical}" id="medical">
									</div>
								</div>
								<div class="form-group">
									<label class="col-lg-2 control-label">House Rent:</label>
									<div class="col-lg-5">
										<input type="number" class="form-control" name="houseRent"
											value="${salary.houseRent}" id="houseRent">
									</div>
								</div>
								<div class="form-group">
									<label class="col-lg-2 control-label">Conveyance:</label>
									<div class="col-lg-5">
										<input type="number" class="form-control" name="conveyance"
											value="${salary.conveyance}" id="conveyance">
									</div>
								</div>
								
								<div class="form-group">
									<label class="col-lg-2 control-label">Consolidated Salary:</label>
									<div class="col-lg-5">
										<input type="number" class="form-control" name="consalitedSalary"
											value="${salary.consalitedSalary}" id="consalitedSalary">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-lg-5">
										<input type="text" class="form-control"
											value="${salary.remarks}" name="remarks"
											id="remarks">
									</div>
								</div>
